...
def search(query: str = ""):
    ...
    questions_indices = search_code_documents(
        query, so_encoder_model, so_faiss_index, query_tokenizer, n_results=15
    )
    return {
        "soQuestionIds": [so_id_mapping[index] for index in questions_indices],
        "extractedFunctionIds": [
